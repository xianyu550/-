    ...
    <style>
        * {
        ...
        .logo {
            ...
            font-size: 18px;
            /* 替换为你的 Logo 图片：
            background: url('your-calculator-logo.png') no-repeat center/cover;
            */
        }
        .title {
            font-size: 22px;
...
<body>
    ...
    <script>
        ...
        function clearDisplay() {函数清空显示屏() {
            currentInput = '0';当前输入 = '0';
            updateDisplay();
        }

        function deleteLast() {函数删除最后一个() {
            if (currentInput.length === 1) {如果 (当前输入长度 === 1) {
                currentInput = '0';当前输入 = '0';
            } else {
        ...
        function calculate() {
            try {
                // 替换 × 为 *，÷ 为 /// 将 × 替换为 *，÷ 替换为 /// 将 × 替换为 *，÷ 为 /// 将 × 替换为 *，÷ 替换为 /// 将 × 替换为 *，÷ 为 /// 将 × 替换为 *，÷ 为 /// 将 × 替换为 *，÷ 为 ///// 将 × 替换为 *，÷ 为 /// 将 × 替换为 *，÷ 为 /// 将 × 替换为 *，÷ 为 /// 将 × 替换为 *，÷ 为 /// 将 × 替换为 *，÷ 为 /// 将 × 替换为 *，÷ 为 ///
